...
export const HappinessTest = props => {
    ...
    const saveTestResults = (e) => {
        ...
        if (firstQuestion !== "" && secondQuestion !== "" && thirdQuestion !== "" && fourthQuestion !== "" && fifthQuestion !== "") {
            const HappinessTest = firstQuestion + secondQuestion + thirdQuestion + fourthQuestion + fifthQuestion
            sessionStorage.setItem("HappinessTest", HappinessTest)
            history.push("/HappinessResult")
        } else {
    ...
    <>
        ...
        <Form widths='equal' className="tests" onSubmit={saveTestResults}>
            ...
            <Form.Field
                ...
                inline
                control={Select}
                label='1. Happy or joyful'
                options={HappinessChoices}
            ...
            <Form.Field
                ...
                inline
                control={Select}
                label='2. Hopeful and optimistic'
                options={HappinessChoices}
                placeholder='How do you feel Now?'
            />
            <Form.Field
                ...
                inline
                control={Select}
                label='3. Worthwhile, high self-esteem'
                options={HappinessChoices}
                placeholder='How do you feel Now?'
            />
            <Form.Field
            ...
            <Form.Field
                ...
                inline
                control={Select}
                label='5. Pleased and satisfied with life'
                options={HappinessChoices}
                placeholder='How do you feel Now?'
            />
            <Form.Field>
                <Button type="submit"> Happiness Results </Button>
            </Form.Field>
        </Form>
        </Container>
    </>
